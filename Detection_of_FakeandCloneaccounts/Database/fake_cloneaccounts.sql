...
--
-- Host: localhost
-- Generation Time: Jan 07, 2021 at 10:29 AM
...
--
-- Database: `fake_cloneaccounts`
--
CREATE DATABASE IF NOT EXISTS `fake_cloneaccounts` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fake_cloneaccounts`;
...
('0nqhektf97ftn549x27gdv860szlt6sx', 'eyJ1c2VyaWQiOjExfQ:1kwOSS:7KnX6Wv2FjLGtJXMI3IuSAH9YKd-FxF1wRiH-uNuQNs', '2021-01-18 11:55:32.330277'),
...
('sel4vfrecch6a4xykikgdr03q1glrjqz', 'eyJ1c2VyaWQiOjEzfQ:1kxSSd:xJO18RZKC_4dA60V6SlZxNoWj4HEBLmQaAfzdCovhts', '2021-01-21 10:24:07.589221'),
...
(10, 'Omkar', 'Omkar.123@gmail.com', 'Omkar', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(11, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(12, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'Inidia', 'Karnataka', 'Bangalore'),
(13, 'Anand', 'Anand123@gmail.com', 'Anand', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_clone1_accounts_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_clone1_accounts_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `tweet_desc` varchar(300) NOT NULL,
  `tweet_loc` varchar(30) NOT NULL,
  `tweet_date` varchar(30) NOT NULL,
  `score` int(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=17 ;

--
-- Dumping data for table `remote_user_clone1_accounts_model`
--

INSERT INTO `remote_user_clone1_accounts_model` (`id`, `uname`, `dob`, `gender`, `sex`, `address`, `location`, `mailid`, `mobile_no`, `names`, `tweet_desc`, `tweet_loc`, `tweet_date`, `score`) VALUES
(16, 'Raju', '1985-05-06 00:00:00', 'Male', '', '#8928,7th Main,Gopi Nagar', 'Gopinagar', 'raju123@gmail.com', '9535866270', 'CAA Protest', 'CAA Protest will be very dangerous scheme In India', 'Gopinagar', '2020-09-08 00:00:00', 6);

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_clone_accounts_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_clone_accounts_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uname` varchar(30) NOT NULL,
  `dob` varchar(30) NOT NULL,
  `gender` varchar(30) NOT NULL,
...
--
-- Table structure for table `remote_user_fake_accounts_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_fake_accounts_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uname` varchar(30) NOT NULL,
  `dob` varchar(30) NOT NULL,
  `gender` varchar(30) NOT NULL,
...
--
-- Dumping data for table `remote_user_fake_accounts_model`
--

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_tweet_accuracy_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_accuracy_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `accuracy` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_tweet_accuracy_model`
--
